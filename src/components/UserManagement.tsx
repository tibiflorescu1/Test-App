...
const UserManagement: React.FC = () => {
  ...
  const mockUsers = [
    ...
    },
    {
      ...
      email: 'elena.georgescu@company.ro',
      role: 'employee',
      status: 'active',
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Administrează utilizatorii sistemului</p>
        </div>
        <button
                    ...
                    <div className="flex items-center">
                      {user.status === 'active' ? (
                        ...
                        <>
                          ...
                          <span className="text-sm text-red-600">Inactiv</span>
                        </>
                      )}
                    </div>
                  </td>
      ...
      {filteredUsers.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500">Nu au fost găsiți utilizatori.</p>
        </div>
      )}
    </div>
  );
